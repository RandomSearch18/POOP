...
def integer_range(prompt, min_inclusive: int, max_inclusive: int, error_message: str = "Enter a valid whole number") -> int:
    ...
    while not is_within_range:
        ...
        if not is_within_range:
            error_incorrect_input(f"Enter a number between {min_inclusive} and {max_inclusive} (inclusive)")
